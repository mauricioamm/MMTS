...
class TodosOsBlocos(models.Model):
    id = models.AutoField(primary_key=True)
    NoBloco = models.IntegerField (default=0)
    NomeBloco = models.TextField(max_length=50, blank=True, default='')
    CriterioSim = models.IntegerField (default=0)
    CriterioNao = models.IntegerField(default=0)
...
class BlocoSaidaModel(models.Model):
    ...
    ErroTipo = models.CharField(max_length=10, blank=True, default='')
    SeBlocoAtual = models.TextField(max_length=3, blank=True, default='')
...
class ProcedCond1Model(models.Model):
    ...
    CriterioTotal = models.TextField(max_length=5, blank=True, default='')
    CriterioErrosTipo = models.TextField(max_length=5, blank=True, default='')
