...
def ResetSaida(request):
    ...
    objeto_participante= ParticipanteModel.objetos.using(banquinho).last()
    objeto_participante.NoBlocoProximo='1'
...
def Entrada_Iniciar(request):
    ...
    if request.POST.get('comecar_sessao'):
        ...
        return render(request, 'MtsApp/ComecarBloco.html', context)
    context= {
        'xqualbloco': xqualbloco
    }

    return render(request, "MtsApp/Entrada_iniciar.html", context)
...
def FimBloco_view(request):
    ...
    if xpassou == 'SIM':
        ...
        objeto_participante.save()
        print('linha 1028, passou; objeto_participante.NoBlocoProximo: ', nCriterioSim)
    else:
        objeto_participante.NoBlocoProximo = nCriterioNao
        objeto_participante.save()
        print('Linha 1032, não passou; objeto_participante.NoBlocoProximo: ', nCriterioNao)

    xbloco= objeto_saida.NomeBloco
    xcriterio= xpassou
    xproximo= objeto_participante.NoBlocoProximo
    ...
    return render(request, 'MtsApp/FimBloco.html', context)
...
def FimBlocoAcertou_view(request):
    ...
    return render(request, 'MtsApp/FimBlocoAcertou.html', context)
...
def FimBlocoErrou_view(request):
    ...
    return render(request, 'MtsApp/FimBlocoErrou.html', context)
